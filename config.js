...
export const config = {
  ...
  screening: {
    ...
    okxEnrichment:     u.okxEnrichment     ?? false, // OKX risk enrichment — both upstreams dead (direct=402 x402-paywall, relay=410 deprecated). Off by default; orion discards enrichment fields anyway.
